...
public class StreamVs {
    ...
    public void oldCartHandle() {
         ...
         * 排序
         */
        notBooksSkuList.sort((sku1, sku2) -> sku2.getTotalPrice().compareTo(sku1.getTotalPrice()));
    ...
    public void newNewCartHandle() {
         ...
         * 收集结果
         */
        List<Sku> toSort = new ArrayList<>();
        for (Sku sku : CartService.getCartSkuList()) {
            System.out.println(
                    JSON.toJSONString(sku, true));
            if (!SkuCategoryEnum.BOOKS.equals(
                    sku.getSkuCategory())) {
                toSort.add(sku);
            }
        }
